...
yargs(hideBin(process.argv))
    ...
    .command('compile', 'compile composite to runtime ...', (yargs) => {
    return yargs
        .option('c', {
        alias: 'ceramicUrl',
        type: 'string',
    ...
    .command('deploy', 'tell node to index a composite', (yargs) => {
    return yargs
        .option('c', {
        alias: 'ceramicUrl',
        type: 'string',
    ...
    .command('query', 'fetch records', (yargs) => {
    return yargs
        .option('c', {
        alias: 'ceramicUrl',
        type: 'string',
    ...
    .command('mutate', 'Alternative ComposeDB client', (yargs) => {
    return yargs
        .option('c', {
        alias: 'ceramicUrl',
        type: 'string',
    ...
    .command('resources', 'fetch array of resources indexed by client', (yargs) => {
    ...
    .command('definition', 'fetch definition', (yargs) => {
    return yargs
        .option('c', {
        alias: 'ceramicUrl',
        type: 'string',
