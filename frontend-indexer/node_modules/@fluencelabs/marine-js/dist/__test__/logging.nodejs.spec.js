...
describe('WASM logging tests in nodejs', function () {
    it('Testing logging level', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    greeting = _a.sent();
                    faas = new FaaS_1.FaaS(marine, greeting, 'srv', undefined, { WASM_LOG: 'info' });
                    return [4 /*yield*/, faas.init()];
                case 3:
                    _a.sent();
                    res = faas.call('log_info', [], undefined);
                    // assert
                    // @ts-ignore
...
//# sourceMappingURL=logging.nodejs.spec.js.map