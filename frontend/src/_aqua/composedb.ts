...
export interface ComposeDBSrvDef {
    ...
    mutate: (display_name: string, cap: string, connection: { composite: string; model: string; name: string; pid: number; port: string; timestamp: number; user: string; }, cid: string, callParams: CallParams$$<'display_name' | 'cap' | 'connection' | 'cid'>) => { stderr: string; stdout: string; } | Promise<{ stderr: string; stdout: string; }>;
    query: (connection: { composite: string; model: string; name: string; pid: number; port: string; timestamp: number; user: string; }, cid: string, callParams: CallParams$$<'connection' | 'cid'>) => { stderr: string; stdout: string; } | Promise<{ stderr: string; stdout: string; }>;
